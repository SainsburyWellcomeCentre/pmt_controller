...
# Modified by Graeme McPhillips
# To add wrap function to encoder values
# 2023-09-21
...
class Encoder:
    ...
    def __init__(self, pin_x, pin_y, v=0, div=1, vmin=None, vmax=None, wrap=False,
        ...
        asyncio.create_task(self._run(vmin, vmax, wrap, div, mod, callback, args))
    ...
    async def _run(self, vmin, vmax, wrap, div, mod, cb, args):
